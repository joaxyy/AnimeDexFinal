...
export default class Home extends Component{
  ...
  <View style={styles.ttCont1}>   
        <Text style={styles.Subtitle1}>
            ...
            <TouchableOpacity style={styles.acInfoA} onPress={ ()=> 

              this.props.navigation.navigate('Rank') }>   Click To See More{" >>>"}</TouchableOpacity>
      
      </Text>  
      <View style={styles.ttCont2}> 
        <TouchableOpacity onPress={() => this.props.navigation.navigate('AOT')}>
            <Image style={styles.ta1}source={require('./assets/aotTA.jpg')} />
        </TouchableOpacity>
        <TouchableOpacity onPress={() => this.props.navigation.navigate('Horimiya')}>
